...
//        product36.setProductImage(readImageBytes(Products.AVOCADO.name()));
        ...
        user2.setPassword(new BCryptPasswordEncoder().encode("password123"));
        ...
        user3.setPassword(new BCryptPasswordEncoder().encode("password123"));
        ...
        user4.setPassword(new BCryptPasswordEncoder().encode("password123"));
